...
const Image: TopicImageType = async (props) => {
  ...
  return new ImageResponse(
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <svg height='100%' stroke='#1676f2' strokeLinecap='round' strokeLinejoin='round' strokeWidth={3} viewBox='0 0 24 24'>
    ...
    ),
    {
      fonts: [
        {
          data: await getGoogleFont(`https://fonts.googleapis.com/css2?family=${FONT_NAME.replace(/\s/gu, '+')}:wght@${FONT_WEIGHT}&text=${topicId}`),
          name: FONT_NAME,
          weight: FONT_WEIGHT
        }
      ],
