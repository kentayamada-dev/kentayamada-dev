      ...
      <main className='flex w-full flex-col'>
        ...
        >
          <div className='flex w-7xl items-center gap-5 self-center px-5 py-5 sm:px-10 sm:py-10'>
            <div className='size-12 rounded-full bg-blue-200/50 p-3 text-blue-500 sm:size-20 sm:p-4 dark:bg-slate-900/70'>
              <HashTagIcon />
            </div>
            <h1 className='text-primary text-2xl font-bold tracking-tight sm:text-4xl'>{topic}</h1>
          </div>
        </header>
