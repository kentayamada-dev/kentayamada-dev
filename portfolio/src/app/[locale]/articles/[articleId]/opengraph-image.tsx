...
import { getDateString, isSameDate, throwColoredError } from '@/utils';
...
const Image: ArticleImageType = async (props) => {
  ...
  const firstPublishedAt = new Date(article.sys.firstPublishedAt);
  const publishedAt = new Date(article.sys.publishedAt);
  const isDateSame = isSameDate(firstPublishedAt, publishedAt);
          ...
          >
            ...
            >
              ...
              >
                ...
                <span>{getDateString(firstPublishedAt, locale)}</span>
              </div>
              {!isDateSame && (
                <div
                  style={{
                ...
                >
                  ...
                  <span>{getDateString(publishedAt, locale)}</span>
                </div>
              )}
            </div>
            <svg fill='black' viewBox='-5 -5 160 110' width='120'>
