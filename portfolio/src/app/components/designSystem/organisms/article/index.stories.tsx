...
const meta = {
  ...
  args: {
    ...
    content: (
      <section>
        ...
        <p>
          The ocean stretches out to the horizon, offering a sense of infinity. The vast expanse of water is both calming and humbling, reminding us
          of the immense scale of nature.
        </p>
  ...
  render: (args): JSXElementType => {
    const { createdAt, updatedAt, ...rest } = args;

    return <Article createdAt={new Date(args.createdAt)} updatedAt={new Date(args.updatedAt)} {...rest} />;
  }
