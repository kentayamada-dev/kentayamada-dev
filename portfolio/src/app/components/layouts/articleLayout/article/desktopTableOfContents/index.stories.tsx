...
const meta = {
      ...
      return (
        <>
          <section className={`${articleClassName} hidden`}>
            ...
            <p>
              Mountains stand tall and proud, their peaks often shrouded in mist. These natural giants inspire awe and
              are often seen as symbols of strength and endurance.
            </p>
            ...
            <p>
              Nature offers endless wonders, from the serenity of forests to the majesty of mountains and the
              tranquility of oceans. Each element of nature provides a unique experience that connects us to the earth
              and ourselves.
            </p>
          </section>
  ...
  title: 'Layouts/Article Layout/Article/Desktop Table of Contents'
