...
import { NotFoundAnimation } from '@/components/atoms';
...
const NotFound: NotFoundType = (props) => {
  ...
  return (
    <div className='flex flex-col items-center px-5'>
      ...
      <h1 className='text-2xl font-extrabold text-slate-900 sm:text-3xl dark:text-slate-200'>{props.mainMessage}</h1>
