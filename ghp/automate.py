        ...
        urls: list[dict[str, str]] = [
            {
                ...
                "image_url": f"https://og-rosy-five.vercel.app/api/og?title={quote(item['fields']['title'])}&subtitle={quote(item['fields']['subtitle'])}&date={quote(self.__get_date_string(item['sys']['createdAt'], current_date_string))}",  # noqa: E501
            }
